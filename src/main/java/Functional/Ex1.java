...
public class Ex1 {
    public static void main(String[] args) {
        ...
        everySecondChar.apply("abcdefgh");


    }

    Function<String, String> expression = source -> {
        StringBuilder returnVal = new StringBuilder();
        for (int i = 0; i < source.length(); i++) {
            if (i % 2 == 1) {
                returnVal.append(source.charAt(i));
...
//            return returnVal.toString();
//        }
//In primul rand, cauta pe Google si/sau ChatGPT si/sau in documentatia din IntelliJ
// ce face StringBuilder si metoda append.
//
...
// si apeleaza everySecondCharacter() pasandu-i functia lambda creata ca prim parametru
