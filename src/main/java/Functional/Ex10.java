...
//        Output: [String text = “acesta etse nu text”“etse”, “nu”], pentru ca acestea sunt cuvintele din badWords care se regasesc in text
...
//        Rezolva problema si fara expresii lambda
    public static void main(String[] args) {
        ...
        List<String> foundBadWords = Arrays.stream(testWords)
